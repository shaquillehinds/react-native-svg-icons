...
export default function SearchNormal1({
  size,
  color,
}: {
  size?: number;
...
<Path d="M11.5 21C16.7467 21 21 16.7467 21 11.5C21 6.25329 16.7467 2 11.5 2C6.25329 2 2 6.25329 2 11.5C2 16.7467 6.25329 21 11.5 21Z" fill={color || '#292D32'}/>
