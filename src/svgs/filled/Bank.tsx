  ...
  return (
    ...
    >
      <Path
        ...
        {...pathProps}
      />
      <Path d="M7 11H5V18H7V11Z" fill={color || '#292D32'} {...pathProps} />
      <Path d="M11 11H9V18H11V11Z" fill={color || '#292D32'} {...pathProps} />
      <Path d="M15 11H13V18H15V11Z" fill={color || '#292D32'} {...pathProps} />
      <Path d="M19 11H17V18H19V11Z" fill={color || '#292D32'} {...pathProps} />
      <Path
