...
export default function GooglePlay({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M16.3009 8.49143C16.6109 8.64143 16.6709 9.05145 16.4309 9.29145L14.7609 10.9614L14.0509 11.6715C13.8509 11.8715 13.5409 11.8715 13.3409 11.6715L6.20095 4.53144C5.80095 4.13144 6.27095 3.48145 6.78095 3.73145L16.3009 8.49143Z"
        fill={color || 'black'}
        {...pathProps}
      />
      <Path
      ...
      />
      <Path
        d="M16.2706 15.5187L6.88056 20.2188C6.37056 20.4688 5.90056 19.8188 6.30056 19.4188L13.3506 12.3688C13.5506 12.1688 13.8606 12.1688 14.0606 12.3688L16.4106 14.7188C16.6406 14.9588 16.5706 15.3687 16.2706 15.5187Z"
        fill={color || 'black'}
        {...pathProps}
      />
    </Svg>
