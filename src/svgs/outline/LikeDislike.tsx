...
export default function LikeDislike({
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M22 3.71997V9.31995C22 10.1199 21.66 10.41 20.86 10.41H20.29C19.49 10.41 19.15 10.1199 19.15 9.31995V3.71997C19.15 2.91997 19.49 2.63 20.29 2.63H20.86C21.66 2.63 22 2.90997 22 3.71997Z"
        stroke={color || '#292D32'}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
