...
export default function ArrowCircleUp({
  size,
  color,
}: {
  size?: number;
...
<Path d="M8.46997 13.26L12 9.73999L15.53 13.26" stroke={color || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</Svg>
);
}
