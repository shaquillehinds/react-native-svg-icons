...
export default function MoneyForbidden({
  size,
  color,
}: {
  size?: number;
...
<Path d="M7.75 15.25L2.25 20.75" stroke={color || '#292D32'} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</Svg>
);
}
