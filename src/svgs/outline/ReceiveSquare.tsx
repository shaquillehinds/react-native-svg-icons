...
export default function ReceiveSquare({
  size,
  color,
}: {
  size?: number;
...
<Path d="M9 11.51L12 14.51L15 11.51" stroke={color || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<Path d="M12 14.51V6.51001" stroke={color || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
