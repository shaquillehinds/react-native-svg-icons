...
export default function dSquare({
  size,
  color,
}: {
  size?: number;
...
<Path d="M6.69995 9.26001L11.9999 12.33L17.2599 9.28001" stroke={color || '#292D32'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
