...
export default function FormatCircle({
  ...
  return (
    ...
    >
      <Path
        d="M21.5 5.35C21.5 6.26 21.07 7.07 20.41 7.59C19.93 7.97 19.32 8.2 18.65 8.2C17.07 8.2 15.8 6.93 15.8 5.35C15.8 4.68 16.03 4.08 16.41 3.59H16.42C16.93 2.93 17.74 2.5 18.65 2.5C20.23 2.5 21.5 3.77 21.5 5.35Z"
        stroke={color || '#292D32'}
        strokeWidth="1.5"
        strokeLinecap="round"
